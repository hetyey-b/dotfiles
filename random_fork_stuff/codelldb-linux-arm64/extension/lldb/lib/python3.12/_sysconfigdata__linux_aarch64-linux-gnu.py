...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/aarch64-linux-gnu-gcc -shared  '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'--with-build-python=/tools/host/bin/python3.12' "
                ...
                "-LModules/_hacl' 'CPPFLAGS= -fPIC  "
                "'",
 'CONFINCLUDEDIR': '/install/include',
 'CONFINCLUDEPY': '/install/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.12.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.12.7/lcov-report',
 ...
 'FREEZE_MODULE_BOOTSTRAP': '/tools/host/bin/python3.12 '
 ...
 'INCLDIRSTOMAKE': '/install/include /install/include '
                   '/install/include/python3.12 /install/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'c++ -shared  -Wl,--exclude-libs,ALL '
                '-LModules/_hacl',
 'LDFLAGS': ' -Wl,--exclude-libs,ALL -LModules/_hacl',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.12.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/aarch64-linux-gnu-gcc -shared  '
             '-Wl,--exclude-libs,ALL -LModules/_hacl',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'LIBPL': '/install/lib/python3.12/config-3.12-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LOCALMODLIBS': '-lbz2          -lffi -ldl  -lm  -lncursesw  -lpanelw '
                 ...
                 '-llzma       -lrt      -l:libHacl_Hash_SHA2.a    -lsqlite3  '
                 '-lssl -lcrypto         -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau   '
                 '-luuid         -lm    -lm    -lexpat  -ledit '
                 '-lncursesw         -lz',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 ...
 'MODBUILT_NAMES': '_crypt  _asyncio  _bisect  _blake2  _bz2  _codecs_cn  '
                   ...
                   '_sha2  _sha3  _socket  _sqlite3  _ssl  _statistics  '
                   '_struct  _testbuffer  _testimportmultiple  '
                   '_testinternalcapi  _testmultiphase  _testsinglephase  '
                   '_tkinter  _typing  _uuid  _xxinterpchannels  '
 ...
 'MODLIBS': '-lbz2          -lffi -ldl  -lm  -lncursesw  -lpanelw -lncursesw   '
            ...
            '-l:libHacl_Hash_SHA2.a    -lsqlite3  -lssl -lcrypto         '
 ...
 'MODOBJS': 'Modules/_asynciomodule.o  Modules/_bisectmodule.o  '
            ...
            'Modules/sha3module.o Modules/_hacl/Hacl_Hash_SHA3.o  '
            ...
            'Modules/_testsinglephase.o  Modules/_tkinter.o '
            'Modules/tkappinit.o  Modules/_typingmodule.o  '
            'Modules/_uuidmodule.o  Modules/_xxinterpchannelsmodule.o  '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.12.7 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.12.7/`cat pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
                     '/tools/host/bin/python3.12',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
                   ...
                   '  -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': ' -Wl,--exclude-libs,ALL -LModules/_hacl',
 ...
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': ' -Wl,--exclude-libs,ALL -LModules/_hacl',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.12.7',
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHAREDMODS': 'Modules/_crypt.cpython-312-aarch64-linux-gnu.so',
 'SHELL': '/bin/sh -e',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.12.7 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.7 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.7/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '/tools/host/bin/python3.12',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.12.7 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.7 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.7/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '/tools/host/bin/python3.12 ./Tools/scripts/run_tests.py',
 ...
 'abs_builddir': '/build/Python-3.12.7',
 'abs_srcdir': '/build/Python-3.12.7',
